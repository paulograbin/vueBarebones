<template>
  <div class="table-responsive">
    ...
    <div v-if="loggers">
      ...
      <span>Filtro</span> <input type="text" v-model="filtered" class="form-control" />

      <table class="table table-sm table-striped table-bordered" aria-describedby="Logs">
        <thead>
          <tr title="click to order">
            <th @click="changeOrder('name')" scope="col"><span>Nome</span></th>
            <th @click="changeOrder('level')" scope="col"><span>Nível</span></th>
          </tr>
        </thead>
